...
<html>
    <head>
      <meta charset="utf-8">
        <title>online shop - administracija</title>
    ...
    <body>
        <div id="page">
            <div class="header cf">
                ...
                <div class="logo">Online Shop - Administracija</div>
            ...
            <div class="navigation cf">
                <ul>
                    ...
                    <li><a <?php if (!empty($this->activeNavigation) && $this->activeNavigation == 'kategorije') { echo 'class="active"' ; } ?> href="<?php echo ADMIN_URL . 'proizvodi/kategorije' ?>">Kategorije</a></li>
                    <li><a <?php if (!empty($this->activeNavigation) && $this->activeNavigation == 'proizvodi') { echo 'class="active"' ; } ?> href="<?php echo ADMIN_URL . 'proizvodi' ?>">Proizvodi</a></li>
